...
<body>
	<div id="mainDiv" class="content-body">
		...
		<form id="searchDetails">
			...
			<div align="center"><span class='mainTitle'>Search And Update Result</span></div>
			<table class="tableStyle" align="center">
				...
				<tr>
					...
					<td colspan="2" align="left"><input value="Search"
						type="button" class="button" onclick="searchResult();" /></td>
				</tr>
			</table>
		</form>
		<input id="resultId" type="hidden" value="" />
		<div id="marksTable" align="center" style="display: none;">
			<table class="tableStyle" align="center">
				<tr>
					<td><label>Marks</label></td>
					<td><input type="text" value="" id="marks"
